...
export const TicketApprovedEmail = ({
  ...
  <Html>
    <Head />
    <Preview>Your ticket {ticketNumber} has been approved</Preview>
    <Body style={main}>
      <Container style={container}>
        <Heading style={h1}>Ticket Approved</Heading>

        <Text style={text}>Hi {employeeName},</Text>

        <Text style={text}>
          Great news! Your ticket has been approved.
        </Text>
        ...
        {approverNotes && (
          <>
            <Hr style={hr} />
            <Section>
              <Text style={detailLabel}>Approver Notes:</Text>
        ...
        <Text style={text}>
          The requested changes have been applied to your profile/records.
          You can view the updated information in your dashboard.
        </Text>
